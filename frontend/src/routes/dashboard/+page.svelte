  ...
  <form on:submit|preventDefault={handleCreateProject} class="space-y-5">
    ...
    <div>
      ...
      <textarea
        ...
        class="w-full px-4 py-3 rounded-xl border border-slate-700/50 focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all text-sm resize-none"
...
<Modal bind:open={showEditModal} title="Edit Project">
  <form on:submit|preventDefault={handleEditProject} class="space-y-5">
    ...
    <div>
      <label
        for="edit_desc"
        class="block text-sm font-medium text-cyan-50 mb-1">Description</label
      >
      <textarea
        id="edit_desc"
        rows="3"
